...
class ReduceDimStrategy(StepStrategy):
    ...
    This class is a subclass of the StepStrategy class. It implements the apply
    method that applies the PolynomialFeatures step to the input data.
    The apply method takes a step_config dictionary as input and returns
    a tuple containing the step name and the PolynomialFeatures object.
    ...
    def apply(self, step_config: dict) -> Tuple[str, PolynomialFeatures]:
        return ("reduce_dim",
                PolynomialFeatures(**step_config["PolynomialFeatures"]))
...
class QTransfStrategy(StepStrategy):
    ...
    This class is a subclass of the StepStrategy class. It implements the apply
    method that applies the QuantileTransformer step to the input data.
    The apply method takes a step_config dictionary as input and returns
    a tuple containing the step name and the QuantileTransformer object.
    ...
    def apply(self, step_config: dict) -> Tuple[str, QuantileTransformer]:
        ...
        return ("qtransf",
                QuantileTransformer(**quantile_config))
...
class StdScalerStrategy(StepStrategy):
    ...
    This class is a subclass of the StepStrategy class. It implements the apply
    method that applies the StandardScaler step to the input data.
    The apply method takes a step_config dictionary as input and returns
    a tuple containing the step name and the StandardScaler object.
    ...
    def apply(self, step_config: dict) -> Tuple[str, StandardScaler]:
        return ("stdscaler",
                StandardScaler(**step_config["StandardScaler"]))
