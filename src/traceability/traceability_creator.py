...
# from traceability.implementations.dvc import DVCTraceability
# Uncomment when DVCTraceability is implemented
# from traceability.implementations.biases import BiasesTraceability
# Uncomment when BiasesTraceability is implemented
from exceptions import (
    UnknownTraceabilityTypeError, TraceabilityNotImplementedError
)
...
class Traceability:
    ...
    def create_traceability(traceability_type):
        ...
        raises:
            UnknownTraceabilityTypeError: If the traceability_type
            is not recognized.
            TraceabilityNotImplementedError: If the traceability_type
